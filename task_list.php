                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                ...
                                <?php 
                                $sid=$_SESSION['stdid'];
                                $sql="Select * from job_description where emp_id='$sid' and  status='1' order by id desc";
                                ...
                                while($row = $result->fetch_assoc()) {?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><a href="start_task.php?jid=<?php echo htmlentities($row['id']); ?>"><button class="btn btn-info"><i class="fa fa-edit "></i> Start</button></td>                                         
                                        </tr>
                                        <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
                                </table>
